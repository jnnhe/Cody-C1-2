# 8초 맞춤형 학습 가이드 AI "HOW" 광고 프로젝트"HOW로 당신의 성장을 완주하세요
"AI 멀티모달 생성 도구를 활용하여 제작한 8초 테크 브랜드 숏폼 광고 파이프라인 프로젝트입니다.
## 1. 프로젝트 개요브랜드명: HOW (맞춤형 학습 가이드 AI)
총 러닝타임: 8초 (각 씬당 2초 균등 배분)캠페인 목표: 친근한 캐릭터를 통해 학습자의 레벨업과 성장을 돕는 AI 광고
