...
생성된 이미지, 주요 메시지와 결과, 프롬프트 요약
### Scene 1 HOW 소개 
<img width="345" height="192" alt="1" src="https://github.com/user-attachments/assets/15129c66-c88b-466c-b001-473e9722d4bd" />

입력 프롬프트 : "Cute and friendly doll-like fairy character with big sparkling eyes and a question-mark shaped hair topping, waving hello, bright blue and white palette, 2D vector animation style, soft teal interface background, with an on-screen subtitle 'How' in a large, clear font below the fairy and above the words "MY OWN LEARNING GUIDE AI, HOW."
...
입력 프롬프트 : The fairy character pointing at a glowing digital roadmap screen with branching pathways and checkpoints, clean data flow background, 2D vector style. Below the fairy and above the screen, there is an on-screen text caption "Let's explore various paths that fit your goal. But you should also think about this part." in a clear, legible font.
...
입력 프롬프트 : The fairy character clapping happily while a student holds a tablet with 'LV UP' text, warm golden lighting effect, celebratory atmosphere, 2D vector style. Below the fairy and student, in a clean text box, the English subtitle text is displayed: "ANOTHER STEP LEVEL UP TODAY! MY OWN LEARNING GUIDE AI, HOW".
...
입력 프롬프트 : "Minimal typography title card with a soft sky blue gradient background. A clean brand banner layout is presented with a professional tech brand vibe. The content features two lines of text: the first line reads 'Customized Learning Guide HOW' and the second line reads 'Achieve your growth with HOW'."
